# Generated by Django 2.1.4 on 2018-12-26 04:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myinfo', '0005_auto_20181226_0240'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_id', models.CharField(blank=True, max_length=20)),
                ('receive_id', models.CharField(blank=True, max_length=20)),
                ...
                ('amount_reg', models.FloatField(blank=True, null=True)),
                ('send_money', models.FloatField(blank=True, null=True)),
            ],
        ),
    ]
